const questions = [
    {
        ...
        answers:[
            { text: "Ensure your safety before providing assistance", correct: true },
            { text: "The employee is breathing", correct: false },
            { text: "No one is around", correct: false },
            { text: "The fire alarm has been pressed", correct: false },
        ],
    ...
    question: "For a sprain or strain injury what can be used to support the injured area?",
        answers:[
            ...
            { text: "elastic band", correct: false },
            { text: "paper clip", correct: false },
            { text: "splint or bandage", correct: true },
        ]
    },
    {
        question: "What must you not do when dealing with a fracture?",
        answers:[
            { text: "ring 999", correct: false },
            { text: "Immobilize the injured limb using a splint or bandage", correct: false },
            { text: "attempt to realign the bone.", correct: true },
            { text: "Assess the area", correct: false },
        ]
    ...
    },
    {
        ...
        answers:[
            { text: "Flush with water", correct: false },
            { text: "Alcohol", correct: false },
            { text: "Any foreign object ", correct: false },
            { text: "pressure to the wound using a clean cloth or bandag", correct: true },
        ]
    }
